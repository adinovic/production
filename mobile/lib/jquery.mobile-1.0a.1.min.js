...
(c||"a"));d=="header"?e.attr("role","banner"):e.attr("role","contentinfo");c=e.children("a");var b=c.filter(".ui-btn-left").length,f=c.filter(".ui-btn-right").length;if(!b)b=c.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length;if(!f)f=c.eq(1).addClass("ui-btn-right").length;if(a.mobile.addBackBtn&&d==="header"&&(a.mobile.urlStack.length>1||a(".ui-page").length>1)&&!b&&!e.data("noBackBtn"))a("<a href='#' class='ui-btn-left' data-icon='arrow-l'>Kembali</a>").tap(function(){history.back();return false}).click(function(){return false}).prependTo(e);
