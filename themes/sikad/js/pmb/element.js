...
(function (factory) {
    ...
    $(function () {
        ...
        $(".datePickerWithLabelKey").datepicker({
            dateFormat: 'dd-M-yy',
            yearRange: "1900:+1",
            changeMonth: true,
            changeYear: true,
            onSelect: function(dateText, inst) {
                ...
                $('input[name="'+inputid + '"').val(dateIso);
            }
        ...
        $(".datepicker").datepicker({
            ...
            onSelect: function(dateText, inst) {
                ...
                console.log(year);
                $('input[name="'+inputid+ '[tgl]'+'"]').val(day);
                $('input[name="'+inputid+ '[bln]'+'"]').val(month);
                $('input[name="'+inputid+ '[thn]'+'"]').val(year);
            }
